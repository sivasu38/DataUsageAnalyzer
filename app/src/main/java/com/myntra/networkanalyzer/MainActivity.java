...
public class MainActivity extends ActionBarActivity implements IClickListener,IRenderViewListener,View.OnClickListener,ICheckedListener{
    ...
    public ArrayList<PInfo> res = new ArrayList<PInfo>();
    public CustomRecycleAdapter adapter;
    public int UID;
    public PackageManager pm;
    public ToggleButton compareToggle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncTaskHelper("INSTALLEDPACKAGES",pm,this,this).execute();
    ...
    public void renderRecyclerView(PackageManager pm) {
        adapter = new CustomRecycleAdapter(this,res,pm);
